...
% Edited 23.03.2020 to use last channel as input for events
% Jenifer Miehlbradt

function [EEG, command] = pop_readbdf_JM(filename, blockrange, eventchans, ref, delchan); 
EEG = [];
command = '';
...
% Edit 23.03.2020
eventchans = size(EEG.data,1);
disp('Using last channel for events')
% %%%%%%%%
warning off;
